...
pub fn joker(fighter: &mut L2CFighterCommon) {
    unsafe {
        ...
        if sumi_id(module_accessor) == false { //joker
            if StatusModule::status_kind(module_accessor) == *FIGHTER_STATUS_KIND_ENTRY {
                if WorkModule::is_flag(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_FLAG_PRESET_CHOSEN) == false {
                    ...
                    if ControlModule::check_button_on(module_accessor,*CONTROL_PAD_BUTTON_APPEAL_S_L) {
                        WorkModule::on_flag(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_FLAG_PRESET_CHOSEN);
            ...
            if WorkModule::is_flag(module_accessor,*FIGHTER_JACK_INSTANCE_WORK_ID_FLAG_DOYLE) {
                ...
                && ArticleModule::is_flag(module_accessor,*FIGHTER_JACK_GENERATE_ARTICLE_DOYLE,*WEAPON_JACK_DOYLE_INSTANCE_WORK_ID_FLAG_SOLID) == false {
                    if ControlModule::check_button_trigger(module_accessor,*CONTROL_PAD_BUTTON_APPEAL_S_R) == true { //choose forward
                        if WorkModule::get_int(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND) 
                        == WorkModule::get_int(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PRESET_PERSONA_KIND) {
                            WorkModule::set_int(module_accessor,0,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND);
                        }
                        else {
                            WorkModule::add_int(module_accessor,1,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND);
                            if WorkModule::get_int(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND) >= 9 {
                                let persona_kind = WorkModule::get_int(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PRESET_PERSONA_KIND);
                                WorkModule::set_int(module_accessor,persona_kind,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND);
                            }
                        }
                        ...
                        if WorkModule::get_int(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND) 
                        == WorkModule::get_int(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PRESET_PERSONA_KIND) {
                            WorkModule::set_int(module_accessor,8,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND);
                        }
                        else {
                            WorkModule::add_int(module_accessor,-1,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND);
                            if WorkModule::get_int(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND) <= -1 {
                                let persona_kind = WorkModule::get_int(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PRESET_PERSONA_KIND);
                                WorkModule::set_int(module_accessor,persona_kind,FIGHTER_JACK_INSTANCE_WORK_ID_INT_PERSONA_KIND);
                            }
                        }
                ...
                else if WorkModule::is_flag(module_accessor,FIGHTER_JACK_INSTANCE_WORK_ID_FLAG_CHANGE_PERSONA) {
